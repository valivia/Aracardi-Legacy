...
import PlayerComponent from "src/components/player/player.module";
import styles from "./players.module.scss";
import ModalComponent from "src/components/global/modal.module";
import PlayerMenuComponent from "src/components/player/player_menu.module";
